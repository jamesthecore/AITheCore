...
AAITheCoreBTCharacter::AAITheCoreBTCharacter()
{
...
void AAITheCoreBTCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void AAITheCoreBTCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AAITheCoreBTCharacter::Move);
...
void AAITheCoreBTCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AAITheCoreBTCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
